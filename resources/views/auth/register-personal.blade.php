@section('title',  title('Registrace - Osobní účet'))
<x-app-layout>
    <x-slot name="header">
    ...
    <x-container>
        <x-inner-container class="sm:max-w-md m-auto flex flex-col gap-4">
            <h1 class="text-3xl font-bold text-center">Osobní účet</h1>

            <!-- Validation Errors -->
            <x-auth-validation-errors :errors="$errors"/>

            <form method="POST" action="{{ route('register-personal') }}" class="flex flex-col gap-4">
            @csrf
